...
namespace Dalle3
{
    ...
    public static class Aliases
    {
        ...
        public static List<Alias> GetAliases()
        {
            ...
            var robloxGames = new Alias("GPTRobloxGames", "Adopt Me: Neon Pets, Apocalypse Rising, Bad Business, Balloon Simulator, Bird Simulator, Clone Tycoon 2, Crazy Knife, Cube eat Cube, " +
                "Dance Your Blox Off, Firefighter Simulator, Flood Escape 2, Guest World, Heroes Online, Hide and Seek Extreme, Ice Cream Simulator, Mining Simulator 2, Parkour Simulator, Please Donate, Prison Life, " +
                "Restaurant Tycoon 2, RoCitizens, Robeats, Robloxian Highschool, Rumble Quest, SCP: Roleplay, Saber Simulator, SharkBite, Snow Shoveling Simulator, Soccer Legends, Strucid, Super Bomb Survival!!, " +
                "Super Doomspire, Survive the Killer, Swordburst 2, Terrain Parkour, Texting Simulator, The Floor is Lava, Tower Battles, Ultimate Driving: Westover Islands, Wizard Tycoon - 2 Player, World // Zero, " +
                "Zombie Rush, Blade ball, Cube eat cube, Egg Hunt, Trade Hangout, Big paintball, Ride a cart simulator, Tiny Tanks, Hueblox, Classic Crossroads, Grass Cutting Tycoon, Murder Mystery 2," +
                "Swordfight on the heights, Sword fighting simulator, Bee Swarm Simulator, Sword Fight Tornument, +1 fat every second, Trade Hangout, Catalog Heaven, Mermaid Life, Hueblox, My Droplets, " +
                "Crossroads, The Underground War, mortal coil, Wacky Wizards, Welcome to the town of Robloxia - Building, Nuke the Whales, BIRD, Bloxfruits, Deception Infection, Super Golf, Weight Lifting Simulator," +
                " Watermelon Go, BIG Paintball, Bladeball, Survive a plane crash, Fall down a 10000 stud hole, Build to survive the dragobloxers, VR Hands, Condo Games, On Tap, DOORS, Santa's Winter Fortress, Tower Defense Simulator, A wolf or other, Cleaning Simulator, Loomian Legacy, Broken Bones IV, Project Lazuras, Apocalypse Rising, Obby but you're on a bike, The Roblox Happy Home, Gucci Garden, Catalog Avatar Creator, Reason 2 Die, Mad Murderer, Miner's Haven, The Wind, Islands, Adopt Me!, Tower of Hell, Brookhaven 🏡RP, MeepCity, Murder Mystery 2, Blox Fruits, Arsenal, Royale High, Piggy, Jailbreak, Shindo Life, Anime Fighting Simulator, Bee Swarm Simulator, Welcome to Bloxburg, Build A Boat For Treasure, Mad City, Dungeon Quest, Vehicle Simulator, Ninja Legends, Bubble Gum Simulator, Tower Defense Simulator, Phantom Forces, Boku No Roblox, Super Power Training Simulator, Mining Simulator, Dragon Ball Z Final Stand, Shinobi Life 2, Natural Disaster Survival, Work at a Pizza Place, Blox Piece, Adopt and Raise a Cute Kid, Speed Run 4, Weight Lifting Simulator 3, Roblox High School, Theme Park Tycoon 2, Epic Minigames, Lumber Tycoon 2, Super Hero Tycoon, Treasure Hunt Simulator, Island Royale, Zombie Attack, Pet Simulator X, Flee the Facility, Skywars, Vehicle Tycoon, Booga Booga, Lucky Block Battlegrounds, Pokemon Brick Bronze, Among Us");

            var games = new Alias("GPTGames", "Clash of Clans, Angry Birds, Candy Crush, Pokemon Go, Call of Duty: Modern Warfare, Super Mario Bros., The Legend of Zelda, Tetris, Minecraft, GTA V," +
                " The Elder Scrolls V: Skyrim ,  World of Warcraft, Overwatch, Super Smash Bros. Ultimate, Dark Souls III, The Witcher 3, Counter-Strike, DOTA 2, League of Legends, Everquest, Plants vs Zombies, 2048, " +
                "Minesweeper, Freecell, Fruit Ninja, Simcity, The Sims, Rocket League, Diablo II, Path of Exile, Stardew Vallye, Garry's Mod, PubG, Bejeweled, Final Fantasy VII, Assassin's Creed, Metal Gear Solid V, " +
                "Animal Crossing, Halo: Combat Evolved, Portal, Beat Saber, Werewolf, Sudoku, Yu-Gi-Oh!, Magic: The Gathering, Dance Dance Revolution, Quidditch, Chess, Checkers, Baduk aka Weiqi aka go, Tic-Tac-Toe, " +
                "Hades, Nethack, Solar Scuffle, Apex Legends, Splatoon 2, Sea of Thieves, Military Madness aka Nectaris, Arkanoid, Donkey Kong Jr., Subnautica, The Last of Us, Pinball, Quake, Myst, " +
                "Street Fighter II Turbo, Sonic the Hedgehog, GoldenEye 007, Half-Life, StarCraft, Guitar Hero, Wii Sports, Bioshock, Fallout 2, Pong, Battleship, Club, Frogger, Asteroids, Duck Hunt, " +
                "Prince of Persia, Mortal Kombat, The Oregon Trail, Lemmings, fortnite, slay the spire, factorio, Mega Man X, Factorio, EarthBound, Deus Ex, Populous, Baldur's Gate, Age of Empires II: The Age of Kings," +
                "Axis and Allies, Risk, Gears of War, Castlevania ");

            var historySpots = new Alias("GPTHistory", "1200 Iceland, 1920 Iceland, 1500ad, 10bc finland, 1000ad mayan empire, 10000 years BR in caveman times, 100 million years ago among dinosaurs, in a time travel time machine, in the super far future, \" +\r\n\"1200ad peru, 1900 buenos aires, 1966 falkland islands, 1000bc northern canada, 1000bc nunavut, 2020 toronto, 2022 vancouver, 1000 bc, 0ad, 10ad, 40ad rome, 400ad babylon, 800ad kazakhstan, 1200 china, 2000 china, 2005 beijing, 2010 japan");
            ...
            var adjectives = new Alias("GPTArtstyles", "Aquarela brasileira, 3D, 3D model, 3D printing art, Abstract, Abstract geometry, Acrylic pour, Action painting, Aerial drone art, " +
                ...
                "Ice carving, Ice sculpting, Ice sculpture, Iconografía bizantina, Glacier carving, fire-melted ice, Lava sculpture, Ikebana (生け花),Mixed media collage, Ilustración digital fantasía, " +
                "Immersive virtual reality, Impressionist, " +
                ...
                "Lost wax casting, Lowbrow, Lowbrow humor, Luces y sombras (Spanish), Light and shadows, Luminous thread embroidery, Macabre, Macro photography, Magnetic fluid art, " +
                ...
                "Ta moko (Māori),traditional skin art., Talla piedra ancestral, Tape art, Tapestry, Tapestry weave, Tapiz flamenco, Tapiz mural contemporáneo, Terrazzo flooring, Textile dyeing," +
            ...
            var aliases = new List<Alias>() {
                    ...
                    compositionTypes,
                    strangeEffects,
                    astro, futuristic, phenomena, mythological, fantastical,
